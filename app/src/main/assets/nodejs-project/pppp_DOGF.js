...
class PPPP_DOGF extends EventEmitter {
  constructor() {
    super()
  ...
  sendBroadcast() {
    const message = Buffer.from('2cba5f5d', 'hex') //2c8ab914
     //2caabd831db1009e4d6287d2f4051924692a84d7acf7bceb13baa84e963adcb52073697ccf321e67

    this.socket.send(message, 32108, '192.168.1.255')
